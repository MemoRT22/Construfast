...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <img
        ref={imgRef}
        src="https://images.pexels.com/photos/15532135/pexels-photo-15532135.jpeg?auto=compress&cs=tinysrgb&w=1920&h=1080&fit=crop"
        alt="Obra de construccion a gran escala con gruas"
        className="absolute inset-0 w-full h-full object-cover object-[center_40%] scale-110"
        loading="eager"
      />
